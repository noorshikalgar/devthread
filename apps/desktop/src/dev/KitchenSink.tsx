...
function Swatch({ name, className }: { name: string; className: string }) {
  return (
    <div className="flex flex-col gap-1.5">
      <div
        className={cn(
          "h-12 w-full rounded-md border border-border/50",
          className,
        )}
      />
    ...
    <div className="mx-auto max-w-5xl space-y-10 px-6 py-10">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold tracking-tight">
          devthread design system
        </h1>
        <p className="text-sm text-muted-foreground">
          Tokens and components, dark-first. Toggle the app theme switcher to
          verify every theme.
        </p>
      </header>
      ...
      <Section title="Typography">
        <div className="space-y-2">
          ...
          <p className="font-mono text-sm">
            Geist Mono — release-v2.4.0 a1b2c3d 14:32:09
          </p>
        </div>
      </Section>
      ...
      <Section title="Elevation & radius">
        <div className="grid grid-cols-3 gap-4 sm:grid-cols-5">
          <div className="flex h-16 items-center justify-center rounded-lg bg-card text-xs text-muted-foreground shadow-xs">
            shadow-xs
          </div>
          <div className="flex h-16 items-center justify-center rounded-lg bg-card text-xs text-muted-foreground shadow-sm">
            shadow-sm
          </div>
          <div className="flex h-16 items-center justify-center rounded-lg bg-card text-xs text-muted-foreground shadow-md">
            shadow-md
          </div>
          <div className="flex h-16 items-center justify-center rounded-lg bg-card text-xs text-muted-foreground shadow-lg">
            shadow-lg
          </div>
          <div className="flex h-16 items-center justify-center rounded-lg bg-card text-xs text-muted-foreground shadow-xl">
            shadow-xl
          </div>
        </div>
      </Section>
      ...
      <Section title="Form controls">
        <div className="grid max-w-md gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="ks-cb" className="text-sm">
              Notify on release
            </label>
          </div>
          <RadioGroup defaultValue="staging" className="flex gap-4">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="ks-r1" className="text-sm">
                Staging
              </label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="prod" id="ks-r2" />
              <label htmlFor="ks-r2" className="text-sm">
                Production
              </label>
            </div>
          </RadioGroup>
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="ks-sw" className="text-sm">
              Auto-deploy
            </label>
          </div>
          <Progress value={64} />
      ...
      <Section title="Alerts & toasts">
        <div className="space-y-3">
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Check the CI logs for stage "test".
            </AlertDescription>
          </Alert>
          <div className="flex gap-2">
            <Button
              size="sm"
              onClick={() => toast.success("Release v2.4.0 shipped")}
            >
